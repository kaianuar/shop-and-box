 ...
 */
 ...
 $link_post_project = JRoute::_('index.php?option=com_jblance&view=item&layout=edititem');
...
<div class="row-fluid">
	...
	<div class="span8">
		...
		<?php		
			...
			echo JText::_('COM_JBLANCE_CURRENT_ORDERS_EMPTY');
		}
		?>

		<!-- wishlist section -->
		<h3><?php echo JText::_('COM_JBLANCE_WISHLIST'); ?></h3>
		<?php 
		...
		<?php		
			...
			echo JText::_('COM_JBLANCE_WISHLIST_EMPTY');
		}
		?>

		<!-- past orders section -->
		<h3><?php echo JText::_('COM_JBLANCE_PAST_ORDERS'); ?></h3>
		<?php 
		if(!empty($this->pendings)){
			foreach($this->pendings as $pending){
		?>
		...
		<?php		
			...
			echo JText::_('COM_JBLANCE_PAST_ORDERS_EMPTY');
		}
		?>
